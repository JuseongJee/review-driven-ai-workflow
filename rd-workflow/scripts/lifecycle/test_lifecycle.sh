...
AST_GUARD_SH="$REPO_ROOT/rd-workflow/scripts/hooks/_guard_common.sh"
AST_ARCHIVE_SH="$REPO_ROOT/rd-workflow/scripts/lifecycle/archive.sh"
AST_SMOKE_SH="$REPO_ROOT/rd-workflow/scripts/_smoke_common.sh"
