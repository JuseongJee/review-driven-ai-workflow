...
```bash
bash rd-workflow/extensions/verify/verify.sh --verifier lighthouse
bash rd-workflow/extensions/verify/verify.sh --verifier playwright
bash rd-workflow/extensions/verify/verify.sh --verifier axe
```
...
|------------|-----------------------------------------------|------------------------|
| lighthouse | `rd-workflow/extensions/verify/verifiers/lighthouse.sh`       | Node.js, npx, Chrome   |
| playwright | `rd-workflow/extensions/verify/verifiers/playwright.sh`       | Node.js, npx           |
| axe        | `rd-workflow/extensions/verify/verifiers/axe.sh`             | Node.js, npx           |
