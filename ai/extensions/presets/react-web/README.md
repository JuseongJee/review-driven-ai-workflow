...
```bash
bash ai/scripts/ai/verify.sh --verifier lighthouse
bash ai/scripts/ai/verify.sh --verifier playwright
bash ai/scripts/ai/verify.sh --verifier axe
```
...
|------------|-----------------------------------------------|------------------------|
| lighthouse | `ai/scripts/ai/verifiers/lighthouse.sh`       | Node.js, npx, Chrome   |
| playwright | `ai/scripts/ai/verifiers/playwright.sh`       | Node.js, npx           |
| axe        | `ai/scripts/ai/verifiers/axe.sh`             | Node.js, npx           |
